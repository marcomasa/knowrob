...
#include "knowrob/backend/mongo/MongoTriple.h"
...
#define PIPELINE_RELATION_COUNTER "backend/mongo/aggregation/relation-counter.json"
#define PIPELINE_CLASS_COUNTER "backend/mongo/aggregation/class-counter.json"
